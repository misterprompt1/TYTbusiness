      ...
      <div className="relative z-10 flex flex-col min-h-screen p-[32px] md:p-[64px]">
        ...
        <main className="flex-1 flex flex-col pt-[2vh] md:pt-[4vh] w-full max-w-7xl mx-auto">
          <div className="w-full flex justify-center">
            <h1 className="text-[36px] md:text-[52px] font-bold uppercase tracking-[-0.04em] leading-[0.95] text-white drop-shadow-lg text-center max-w-4xl [word-spacing:5%]">
              Propose les meilleurs services prop firm
            </h1>
          </div>
          <div className="w-full flex justify-start mt-auto pb-4">
            <button className="clip-button bg-brand-red text-white px-8 py-4 text-lg font-bold uppercase tracking-wide hover:bg-red-600 transition-colors">
              Offre unique
            </button>
          </div>
        </main>
        ...
        <div className="w-full max-w-7xl mx-auto mt-auto flex justify-start">
          <div className="glass-card p-6 md:p-8 max-w-sm w-full">
            <h3 className="text-lg font-bold mb-2 uppercase tracking-tight">Optimise ton Business</h3>
            <p className="text-sm text-gray-300 mb-6 leading-relaxed">Propose les meilleurs services Propfirm du marché à ta communauté, ou récupère notre kit complet pour lancer et structurer ta propre offre de A à Z (site, réseaux, comptes funded...)</p>
            <a 
              href="https://calendly.com/tytinsiders/30min" 
              target="_blank" 
              rel="noopener noreferrer"
              className="clip-button bg-white text-brand-black px-6 py-3.5 text-sm font-bold uppercase tracking-wide w-full flex items-center justify-center gap-2 hover:bg-gray-200 transition-colors cursor-pointer"
            >
